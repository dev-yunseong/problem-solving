...
class Solution2 {
    ...
    public class Node {
        ...
        public void cutRealSum(int cutted) {
            if (realSum == -1) {
                realSum = sum;
            }

            // System.out.printf("realSum: %d, cutted: %d, result: %d\n", realSum, cutted, realSum - cutted);
            realSum -= cutted;
        }
        ...
        public Node getRealRoot() {
            ...
            if (parent.left == this && parent.ll) {
                return this;
            }
            if (parent.right == this && parent.lr) {
                return this;
            }

            return parent.getRealRoot();
        }
        ...
        public void cutLeftApply() {
            getRealRoot().cutRealSum(left.getSum());
        }

        public void cutRightApply() {
            getRealRoot().cutRealSum(right.getSum());
